...
function Planning() {
  ...
  const handleEventClick = info => {
    ...
    setEditedEvent({
      ...
      hotel_id: info.event._def.extendedProps.hotel_id
    });
          ...
          <div className={`pop-in ${openPopIn ? "active" : ""}`}>
            <form onSubmit={handleEditEvent}>
              ...
              <input
                type="datetime-local"
                placeholder="Date de début"
                value={moment(editedEvent.dateStart).format(
                  "YYYY-MM-DD[T]HH:MM"
                )}
                onChange={e =>
                  setEditedEvent({
              ...
              <input
                type="datetime-local"
                placeholder="Date de fin"
                value={moment(editedEvent.dateEnd).format(
                  "YYYY-MM-DD[T]HH:MM"
                )}
                onChange={e =>
                  setEditedEvent({
